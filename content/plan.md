...
ТЕСТ-WEBHOOK Желаете отправиться в путешествие? Ознакомьтесь с тем что ниже и заполните форму:
...
### Поездки без дронов
- **Подача заявки:** минимум за 2-3 дня до поездки через [Telegram чат "Пока ты спал"](https://t.me/sleeptrip_rec)
